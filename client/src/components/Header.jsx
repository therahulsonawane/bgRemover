...
function Header() {
  return (
    <div className="flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20">
      {/* ------------ Left Side ----------- */}
      <div>
        <h1 className="text-4xl xl:text-5xl 2xl:text-6xl font-bold text text-neutral-700 leading-tight">
        ...
        <p className="my-6 text-[15px] text-gray-500">
          ...
          Necessitatibus iste provident quaerat minima obcaecati deleniti
        </p>
        <div>
